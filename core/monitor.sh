...
monitor_ssh() {
    ...
    # Menggunakan file sementara untuk mengatasi subshell loop di bash
    tmp_log="/tmp/active_ssh_monitor.log"
    > "$tmp_log"
    
    # Mengekstrak daftar koneksi dari netstat
