...
add_ssh() {
    ...
    msg_cli=$(echo -e "Akun Berhasil Dibuat!\n\n━━━━━━━━━━━━━━━━━━━━\nINFORMASI PREMIUM\nSSH & OVPN ACCOUNT\n━━━━━━━━━━━━━━━━━━━━\nIP-Address: ${IP_ADD}\nHostname: ${DOMAIN}\nUsername: ${user}\nPassword: ${password}\nLimit IP: ${lim_str}\n━━━━━━━━━━━━━━━━━━━━\nPort OpenSSH: 22\nPort Dropbear: 109, 143\nPort SSH WS HTTPS (TLS): 443\nPort SSH WS HTTP (NTLS): 80\nPort BadVPN/UDPGW: 7100, 7200, 7300\n━━━━━━━━━━━━━━━━━━━━\nOPENVPN TCP (1194): http://${DOMAIN}/ovpn/tcp.ovpn\nOPENVPN UDP (2200): http://${DOMAIN}/ovpn/udp.ovpn\n━━━━━━━━━━━━━━━━━━━━\nPayload SSH WS: GET wss://${DOMAIN}/sshws HTTP/1.1[crlf]Host: ${DOMAIN}[crlf]Upgrade: websocket[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf][crlf]\n━━━━━━━━━━━━━━━━━━━━\nPayload WS ENHANCED: PATCH / HTTP/1.1[crlf]Host: [host][crlf]Host: ISI_BUG_DISINI[crlf]Connection: Upgrade[crlf]User-Agent: [ua][crlf]Upgrade: websocket[crlf][crlf]\n━━━━━━━━━━━━━━━━━━━━\nExpired on: ${exp_date} ${exp_time} WIB (${masaaktif} Hari)")
