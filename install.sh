...
# Bersihkan repository Caddy lama (Sangat penting untuk Ubuntu 24.04 agar tidak error GPG/Conflict)
rm -f /etc/apt/sources.list.d/caddy-stable.list
rm -f /usr/share/keyrings/caddy-stable-archive-keyring.gpg

# Proses instalasi dependensi dan penambahan Repository
apt install -y debian-keyring debian-archive-keyring apt-transport-https curl
curl -1sLf 'https://dl.cloudsmith.io/public/caddy/stable/gpg.key' | gpg --dearmor --yes -o /usr/share/keyrings/caddy-stable-archive-keyring.gpg
curl -1sLf 'https://dl.cloudsmith.io/public/caddy/stable/debian.deb.txt' | tee /etc/apt/sources.list.d/caddy-stable.list

# Pisahkan perintah update dan install agar lebih stabil di OS terbaru
apt update -y
apt install caddy -y
